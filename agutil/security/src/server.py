...
from ...io import SocketServer, _PROTOCOL_IDENTIFIER_
...
class SecureServer:
    ...
    def accept(self):
        ...
        return SecureConnection(socket, self.port, self.password, self.rsabits, self.childtimeout, _PROTOCOL_IDENTIFIER_, self.childlogger)
